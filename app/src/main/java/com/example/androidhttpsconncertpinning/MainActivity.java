...
public class MainActivity extends AppCompatActivity {
    ...
    final String port = "4443";
    final String localhostEndpoint = "https://" + host + ":"  + port;
    String uri = "/sample-data.json";
    final List<String> validHosts = new ArrayList<String>(Arrays.asList("localhost", "10.0.2.2", "bs-local.com"));
    ...
    public void addSelfSignedCertInTrustStore() throws Exception
    {
        ...
        keyStore.setCertificateEntry("my self signed cert", bundledSelfSignedCert);
            ...
            public void run() {
                ...
                try {
                    ...
                    for (Certificate cert : certs) {
                        if(bundledSelfSignedCert.getType().equals(cert.getType()) &&
                                bundledSelfSignedCert.hashCode() == cert.hashCode() &&
                                bundledSelfSignedCert.getPublicKey().getAlgorithm().equals(cert.getPublicKey().getAlgorithm()) &&
                                bundledSelfSignedCert.getPublicKey().getFormat().equals(cert.getPublicKey().getFormat())) {
